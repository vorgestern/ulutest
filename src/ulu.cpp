...
const vector<pair<string,string>> Colortags={
    ...
    make_pair("SETUP", bunt(SETUP, blue)),
    make_pair("TEARDOWN", bunt(TEARDOWN, blue)),
...
const vector<pair<string,string>> Blacktags={
    ...
    make_pair("SETUP", SETUP),
    make_pair("TEARDOWN", TEARDOWN),
...
const vector<pair<string,string>> Markdowntags={
    ...
    make_pair("SETUP", markdown(SETUP, mdblue)),
    make_pair("TEARDOWN", markdown(TEARDOWN, mdblue)),
